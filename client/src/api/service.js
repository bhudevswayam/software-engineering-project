...
export const getAllServices = async () => {
  const res = await axios.get(`${BASE_URL}/services/all`, getTokenHeader());
  return res.data;
};

// ==============================
// 🔹 Get All Services (for by business ID)
// ==============================
...
export const getRelatedServices = async (serviceId) => {
  const res = await axios.get(`${BASE_URL}/services/related/${serviceId}`, getTokenHeader());
  return res.data;
};
